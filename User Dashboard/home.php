   ...
   <section class="flex">
      ...
      <div class="icons">
         ...
         <div id="search-btn" class="fas fa-search"></div>
          <a href="../index.html"><div id="user-btn" class="fas fa-user"></div></a>
    ...
    <p class="role">student</p>
     ...
     <nav class="navbar">
      ...
      <a href="contact.html"><i class="fas fa-headset"></i><span>Contact us</span></a>
       <a href="file:///D:/myWebsite/login%20system/index.html"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Log Out</span></a>
   </nav>
